...
describe('UserTokenTypeService', () => {
  ...
  describe('Read', () => {
    ...
    it('should read all the user token types', async () => {
      const result = await userTokenTypeService.findAll();
    ...
    it('should find a user token type by its id', async () => {
      const result = await userTokenTypeService.findById(userTokenType.id);
  ...
  describe('Create', () => {
    ...
    it('should create a new user token type', async () => {
      const result = await userTokenTypeService.create({
  ...
  describe('Update', () => {
    ...
    it('should update a user token type description', async () => {
      const result = await userTokenTypeService.update(userTokenType.id, {
        description: userTokenType.description,
      });
  ...
  describe('Delete', () => {
    ...
    it('should delete a user token type by its id', async () => {
      const result = await userTokenTypeService.delete(id);
